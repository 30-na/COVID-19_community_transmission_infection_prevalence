---
title: "Anova Test for Compare mean of Rt number in CDC Risk level Group"
author: "Sina Mokhtar"
output: pdf_document
---
...
## Sample sizes across groups (Unbalanced)
...
```{r}
## Fit anova model
myfit_sqrt = aov((mean_last_7_days)^.5 ~ cdcTransmissionLevel,
data=data)
summary(myfit_sqrt)
```
...
```{r}
Tukeyfit <- TukeyHSD(myfit_sqrt, conf.level=.95)
Tukeyfit
```
...
comp1<-lsmeans(myfit_sqrt, pairwise ~ cdcTransmissionLevel, adjust="tukey")
