...
1- [Covid Act Now API](https://covidactnow.org/data-api): This API provides comprehensive COVID-19 data, including metrics related to transmission risk and infection rates.By utilizing data from January 2020 to March 2023, we were able to cover a substantial timeframe that includes the early stages of the pandemic up until recent months.  
